...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align: center" role="alert">New Menu Added!</div>');
            redirect('menu');
        }
    }
    ...
    public function update($id)
    {
        ...
        $this->db->update('user_menu', array('menu' => $data), array('id' => $id));
    ...
    public function submenu()
    {
        ...
        $this->load->model('Submenu_model', 'submenu_model');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'menu_id' => $this->input->post('submenu_id'),
                'url' => $this->input->post('url'),
                'icon' => $this->input->post('icon'),
                'is_active' => $this->input->post('is_active')
            ];
            $this->db->insert('user_sub_menu', $data);
            $this->session->set_flashdata('message', '<div class="alert alert-success" style="text-align: center" role="alert">New Sub Menu Added!</div>');
